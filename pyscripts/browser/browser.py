...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Unkown00"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action.setStatusTip("---")  # Hungry!
        ...
        self.add_new_tab(QUrl('https://joyghosh.info'), 'Homepage')

        self.show()

        self.setWindowTitle("Browser-Unkown00")
...
app.setApplicationName("Unkown00-B-Vpn")
app.setOrganizationName("Unkown00")
app.setOrganizationDomain("joyghosh.info")
